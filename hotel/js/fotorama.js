...
! function(a, b, c, d, e) {
    ...
    function $(a, b, c, e, f, h) {
        ...
        if (i || (f.push(arguments), Array.prototype.push.call(arguments, f.length), !(f.length > 1))) {
            ...
            var j = a[0],
                ...
                n = e.time / (h || 1);
            c.removeClass(Pb + " " + Ob), a.stop().addClass(Pb), b.stop().addClass(Ob), l && k && a.fadeTo(0, 0), a.fadeTo(l ? n : 0, 1, l && m), b.fadeTo(n, 0, m), j && l || k || m()
        }
    }
    ...
    function ab(c, e) {
        function f(a) {
            return n = d(a.target), v.checked = q = r = t = !1, l || v.flow || a.touches && a.touches.length > 1 || a.which > 1 || Cc && Cc.type !== a.type && Ec || (q = e.select && n.is(e.select, u)) ? q : (p = "touchstart" === a.type, r = n.is("a, a *", u), o = v.control, s = v.noMove || v.noSwipe || o ? 16 : v.snap ? 0 : 4, _(a), m = Cc = a, Dc = a.type.replace(/down|start/, "move").replace(/Down/, "Move"), (e.onStart || g).call(u, a, {
                control: o,
                $target: n
        ...
        function h(a) {
            if (a.touches && a.touches.length > 1 || Pc && !a.isPrimary || Dc !== a.type || !l) return l && i(), void(e.onTouchEnd || g)();
            _(a);
        ...
        function i(a) {
            (e.onTouchEnd || g)();
            var b = l;
            v.control = l = !1, b && (v.flow = !1), !b || r && !v.checked || (a && X(a), Ec = !0, clearTimeout(Fc), Fc = setTimeout(function() {
                Ec = !1
        ...
        var l, m, n, o, p, q, r, s, t, u = c[0],
            v = {};
        return Pc ? (S(u, "MSPointerDown", f), S(b, "MSPointerMove", h), S(b, "MSPointerCancel", i), S(b, "MSPointerUp", i)) : (S(u, "touchstart", f), S(u, "touchmove", h), S(u, "touchend", i), S(b, "touchstart", j), S(b, "touchend", k), S(b, "touchcancel", k), S(a, "scroll", k), S(u, "mousedown", f), S(b, "mousemove", h), S(b, "mouseup", i)), c.on("click", "a", function(a) {
            v.checked && X(a)
        }), v
    }
    ...
    function bb(a, b) {
        ...
        function f(d, e) {
            D.noSwipe || (A || c(d), l = d._x, p.push([d._now, l]), n = m - (j - l), o = J(n, s, t), s >= n ? n = w(n, s) : n >= t && (n = w(n, t)), D.noMove || (a.css(k(n)), z || (z = !0, e.touch || Pc || a.addClass(cc)), (b.onMove || g).call(B, d, {
                pos: n,
                edge: o
            })))
        }
    ...
    var gb = "fotorama",
        ...
        lc = jc + "-close",
        mc = gb + "__caption",
        nc = gb + "__caption__wrap",
        oc = gb + "__spinner",
        pc = '" tabindex="0" role="button',
        qc = d && d.fn.jquery.split(".");
    ...
    if ("undefined" != typeof b.cancelFullScreen) tc.ok = !0;
    else
        for (var vc = 0, wc = uc.length; wc > vc; vc++)
            if (tc.prefix = uc[vc], "undefined" != typeof b[tc.prefix + "CancelFullScreen"]) {
                tc.ok = !0;
                break
            }
    ...
    var Ac, Bc, Cc, Dc, Ec, Fc, Gc = d(a),
        Hc = d(b),
        Ic = "quirks" === c.hash.replace("#", ""),
        Jc = sc.csstransforms3d,
        Kc = Jc && !Ic,
        Lc = Jc || "CSS1Compat" === b.compatMode,
        Mc = tc.ok,
        Nc = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i),
        Oc = !Kc || Nc,
        Pc = navigator.msPointerEnabled,
        Qc = "onwheel" in b.createElement("div") ? "wheel" : b.onmousewheel !== e ? "mousewheel" : "DOMMouseScroll",
        Rc = 250,
        Sc = 300,
        Tc = 1400,
        Uc = 5e3,
    ...
    jQuery.Fotorama = function(a, e) {
        ...
        function j(b) {
            b !== j.f && (b ? (a.html("").addClass(gb + " " + je).append(pe).before(ne).before(oe), eb(he)) : (pe.detach(), ne.detach(), oe.detach(), a.html(me.urtext).removeClass(je), fb(he)), i(b), j.f = b)
        }
        ...
        function s() {
            var a = 2 > zd || Cd;
            Le.noMove = a || Rd, Le.noSwipe = a || !e.swipe, !Vd && re.toggleClass(zb, !e.click && !Le.noMove && !Le.noSwipe), Pc && pe.toggleClass(qb, !Le.noSwipe)
        }
        ...
        function w() {
            ...
            he.options = e = Q(e), Rd = "crossfade" === e.transition || "dissolve" === e.transition, Ld = e.loop && (zd > 2 || Rd && (!Vd || "slide" !== Vd)), Ud = +e.transitionduration || Sc, Xd = "rtl" === e.direction, Yd = d.extend({}, e.keyboard && ed, e.keyboard);
            var b = {
                add: [],
                remove: []
            };
            zd > 1 ? (Md = e.nav, Od = "top" === e.navposition, b.remove.push(Vb), ve.toggle(!!e.arrows)) : (Md = !1, ve.hide()), cc(), Bd = new xc(d.extend(yc, e.spinner, zc, {
                direction: Xd ? -1 : 1
            })), Ec(), Fc(), e.autoplay && t(e.autoplay), Sd = m(e.thumbwidth) || Wc, Td = m(e.thumbheight) || Wc, Me.ok = Oe.ok = e.trackpad && !Oc, s(), dd(e, [Ke]), Nd = "thumbs" === Md, Nd ? (rc(zd, "navThumb"), Ad = Ae, ge = _c, I(ne, d.Fotorama.jst.style({
                w: Sd,
                h: Td,
        ...
        function Ob(a, b, c, d) {
            (!Zd || "*" === Zd && d === Kd) && (a = p(e.width) || p(a) || Xc, b = p(e.height) || p(b) || Yc, he.resize({
                width: a,
                ratio: e.ratio || c || a / b
            }, 0, d !== Kd && "*"))
        }
        ...
        function Pb(a, b, c, f, g) {
            Nb(a, b, function(a, h, i, j, k, l) {
                ...
                function n() {
                    s.remove(), d.Fotorama.cache[v] = "error", i.html && "stage" === b || !w || w === v ? (!v || i.html || q ? "stage" === b && (j.trigger("f:load").removeClass($b + " " + Zb).addClass(_b), m("load"), Ob()) : (j.trigger("f:error").removeClass($b).addClass(Zb), m("error")), l.state = "error", !(zd > 1 && yd[h] === i) || i.html || i.deleted || i.video || q || (i.deleted = !0, he.splice(h, 1))) : (i[u] = v = w, Pb([h], b, c, f, !0))
                }
                ...
                function o() {
                    ...
                    }, Ob(t.measures.width, t.measures.height, t.measures.ratio, h), s.off("load error").addClass(dc + (q ? " " + ec : "")).prependTo(j), H(s, c || Ke, f || i.fit || e.fit), d.Fotorama.cache[v] = l.state = "loaded", setTimeout(function() {
                        j.trigger("f:load").removeClass($b + " " + Zb).addClass(_b + " " + (q ? ac : bc)), "stage" === b ? m("load") : (i.thumbratio === ad || !i.thumbratio && e.thumbratio === ad) && (i.thumbratio = t.measures.ratio, vd())
                    }, 0)
                }
        ...
        function rc(a, b) {
            Nb(a, b, function(a, c, e, f, g, h) {
                if (!f) {
                    ...
                    var i = f[0];
                    "stage" === b ? (e.html && d('<div class="' + ic + '"></div>').append(e._html ? d(e.html).removeAttr("id").html(e._html) : e.html).appendTo(f), e.caption && d(M(mc, M(nc, e.caption))).appendTo(f), e.video && f.addClass(xb).append(Ee.clone()), W(i, function() {
                        setTimeout(function() {
                            P(qe)
                        }, 0), pd({
                            index: h.eq,
                    ...
                    }), se = se.add(f)) : "navDot" === b ? (qc(i), ze = ze.add(f)) : "navThumb" === b && (qc(i), h.$wrap = f.children(":first"), Ae = Ae.add(f), e.video && f.append(Ee.clone()))
                }
            })
        }
        ...
        function Nc(a) {
            ...
            if (b) {
                var c = Ne.min !== Ne.max,
                    d = a.minMax || c && Ic(Dd[ge]),
                    e = c && (a.keep && Nc.l ? Nc.l : h((a.coo || Ke.nw / 2) - Ic(b).c, d.min, d.max)),
        ...
        function bd(a) {
            Fd = Gd = Ie;
            var b = Dd[Zc];
            b && (Tc(Zc), Pe[Zc].push(b.addClass(Ub)), a || he.show.onEnd(!0), u(re, 0, !0), Vc(Zc), uc(Ed), ab(), db())
        }
        ...
        function jd() {
            if (clearTimeout(jd.t), !e.autoplay || be) return void(he.autoplay && (he.autoplay = !1, fd("stopautoplay")));
        ...
        function kd() {
            he.fullScreen && (he.fullScreen = !1, Mc && tc.cancel(ke), Bc.removeClass(hb), Ac.removeClass(hb), a.removeClass(Xb).insertAfter(oe), Ke = d.extend({}, de), md(Cd, !0, !0), rd("x", !1), he.resize(), Pb(Ed, "stage"), P(Gc, _d, $d), fd("fullscreenexit"))
        }
        ...
        function md(a, b, c) {
            b && (pe.removeClass(lb), Cd = !1, s()), a && a !== Cd && (a.remove(), fd("unloadvideo")), c && (id(), jd())
        }
        ...
        function pd(a) {
            clearTimeout(pd.t), e.clicktransition && e.clicktransition !== e.transition ? (Vd = e.transition, he.setOptions({
        ...
        var yd, zd, Ad, Bd, Cd, Dd, Ed, Fd, Gd, Hd, Id, Jd, Kd, Ld, Md, Nd, Od, Pd, Qd, Rd, Sd, Td, Ud, Vd, Wd, Xd, Yd, Zd, $d, _d, ae, be, ce, de, ee, fe, ge, he = this,
            ...
            oe = d(M(Wb)),
            pe = d(M(ib)),
            qe = d(M(vb)).appendTo(pe),
            re = (qe[0], d(M(yb)).appendTo(qe)),
            se = d(),
            te = d(M(Bb + " " + Db + pc)),
            ue = d(M(Bb + " " + Eb + pc)),
            ve = te.add(ue).appendTo(qe),
            we = d(M(Gb)),
            xe = d(M(Fb)).appendTo(we),
            ye = d(M(Hb)).appendTo(xe),
            ze = d(),
            Ae = d(),
            Be = (re.data(), ye.data(), d(M(hc)).appendTo(ye)),
            Ce = d(M(Yb + pc)),
            De = Ce[0],
            Ee = d(M(kc)),
            Fe = d(M(lc)).appendTo(qe),
            Ge = Fe[0],
            He = d(M(oc)),
            Ie = !1,
            Je = {},
            ...
            Re = 0,
            Se = [];
        pe[Zc] = d(M(wb)), pe[_c] = d(M(Kb + " " + Mb + pc, M(gc))), pe[$c] = d(M(Kb + " " + Lb + pc, M(fc))), Pe[Zc] = [], Pe[_c] = [], Pe[$c] = [], Qe[Zc] = {}, pe.addClass(Kc ? kb : jb).toggleClass(ob, !e.controlsonstart), me.fotorama = this, he.startAutoplay = function(a) {
            return he.autoplay ? this : (be = ce = !1, t(a || e.autoplay), jd(), this)
        }, he.stopAutoplay = function() {
            return he.autoplay && (be = ce = !0, jd()), this
        }, he.show = function(a) {
            var b;
            "object" != typeof a ? (b = a, a = {}) : b = a.index, b = ">" === b ? Gd + 1 : "<" === b ? Gd - 1 : "<<" === b ? 0 : ">>" === b ? zd - 1 : b, b = isNaN(b) ? K(b, yd, !0) : b, b = "undefined" == typeof b ? Ie || 0 : b, he.activeIndex = Ie = D(b), Id = T(Ie), Jd = _(Ie), Ed = [Ie, Id, Jd], Gd = Ld ? b : Ie;
            ...
            var i = g === Dd;
            md(Cd, Dd.i !== yd[x(Fd)].i), rc(Ed, "stage"), uc(Oc ? [Gd] : [Gd, T(Gd), _(Gd)]), rd("go", !0), i || fd("show", {
                user: a.user,
                time: d
            }), be = !0;
            ...
            return Pd && !he.fullScreen && ($d = Gc.scrollTop(), _d = Gc.scrollLeft(), P(Gc), rd("x", !0), de = d.extend({}, Ke), a.addClass(Xb).appendTo(Bc.addClass(hb)), Ac.addClass(hb), md(Cd, !0, !0), he.fullScreen = !0, Qd && tc.request(ke), he.resize(), Pb(Ed, "stage"), jc(), fd("fullscreenenter")), this
            ...
            return he.cancelFullScreen(), he.stopAutoplay(), yd = he.data = null, j(), Ed = [], Vc(Zc), vd.ok = !1, this
            ...
            return "object" == typeof b && a.videoReady && (Qd && he.fullScreen && he.cancelFullScreen(), F(function() {
                ...
                c === Ie && (a.$video = a.$video || d(d.Fotorama.jst.video(b)), a.$video.appendTo(a[Zc]), pe.addClass(lb), Cd = a.$video, s(), ve.blur(), Ce.blur(), fd("loadvideo"))
            })), this
        ...
        var c = "",
            d = (rc.escape, Array.prototype.join);
